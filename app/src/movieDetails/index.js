...
function MovieDetails() {
  ...
  const [episodeData, setEpisodeData] = useState({
    ...
    Solo: {
      introduction: "It is a lawless time. CRIME SYNDICATES compete for resources — food, medicine, and HYPERFUEL. A young man fights for survival but longs to fly among the stars.",
    },
    "The Mandalorian": {
